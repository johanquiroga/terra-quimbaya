...
|
 */
Route::get('country', 'Auth\AuthController@getCountry');
Route::get('departments/{country}', 'Auth\AuthController@getDepartment');
Route::get('cities/{department}', 'Auth\AuthController@getCity');
