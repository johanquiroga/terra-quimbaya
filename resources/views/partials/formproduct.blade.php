        ...
        <div class="col-md-6">
            <div class="input-group">
                ...
                <div class="form-group label-floating{{ $errors->has("'" . $attribute->nombreAtributo . "'") ? ' has-error' : '' }}">
                    ...
                    @else
                        <input id="{{ $attribute->nombreAtributo }}" type="text" class="form-control validate" name="{{ $attribute->nombreAtributo }}" value="{{ $producto->atributos[$attribute->id - 1]->pivot->valorAtributo or old($attribute->nombreAtributo) }}" required aria-describedby="{{ $attribute->nombreAtributo }}Label" onkeypress="return soloLetras(event)">
                    @endif
                    {{--<input id="idTipoCafe" type="text" class="form-control validate" name="id" value="{{ $usuario->id or old("id") }}" required aria-describedby="idLabel" minlength="10" maxlength="10" onkeypress="return soloNumeros(event)">--}}
