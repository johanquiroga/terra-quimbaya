...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-106547709-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments)};
        gtag('js', new Date());

        gtag('config', 'UA-106547709-1');
    </script>
    <meta charset="utf-8" />
    ...
    <meta name="twitter:title" content="YourCoffee, specialty coffee store">
    ...
    <meta name="twitter:image" content="{{ asset('img/Logo_Cafe.svg') }}">

    <!-- You can use Open Graph tags to customize link previews.
    Learn more: https://developers.facebook.com/docs/sharing/webmasters -->
    <meta property="og:url"           content="{{ url('/') }}" />
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="YourCoffee, specialty coffee store" />
    <meta property="og:description"   content="Check this awesome specialty coffee project." />
    <meta property="og:image"         content="{{ asset('img/Logo_Cafe.svg') }}" />
    <meta property="og:site_name" content="YourCoffee" />
...
<body class="landing-page">
    <nav class="navbar navbar-transparent navbar-absolute">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="notranslate navbar-brand" href="{{ route('home') }}">
                    Your Coffee
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navigation-example" style="text-align: center;">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="collapse navbar-collapse" id="google_translate_element"></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="wrapper">
        <div class="header header-filter" style="background-image: url('{{ asset('img/sidebar-5.jpg') }}');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <img style="max-width: 75%; height: auto; overflow: hidden; margin: 0 auto;" src="{{ asset('img/Logo_Cafe.svg') }}" class="img img-responsive" alt="Your Coffee Logo">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main main-raised">
            <div class="container">
                            ...
                            <div class="col-md-3">
                                <div class="info">
                                    <div class="icon icon-primary">
                                        {{--<i class="notranslate material-icons">accessibility</i>--}}
                            ...
                            <div class="col-md-3">
                                <div class="info">
                                    <div class="icon icon-info">
                                        <i class="notranslate material-icons">autorenew</i>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="info">
                                    <div class="icon icon-success">
                                        <i class="notranslate material-icons">access_time</i>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="info">
                                    <div class="icon icon-danger">
                                        <i class="notranslate material-icons">favorite</i>
                                    </div>
                ...
                <div class="section landing-section">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="text-center title">Regálanos tu opinión!</h2>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="row sharing-area text-center">
                                <button id="twitter" class="notranslate btn btn-raised btn-twitter">
                                    <i class="fa fa-twitter"></i>
                                    Tweet
                                </button>
                                <button id="facebook" class="notranslate btn btn-raised btn-facebook">
                                    <i class="fa fa-facebook-square"></i>
                                    Share
                                </button>
                            </div>
...
<script type="text/javascript">
    $().ready(function() {
        ...
        $('#facebook').sharrre({
            ...
            url: '{{ url('/') }}',
            text: 'Check this awesome specialty coffee project',
            title: 'YourCoffee, specialty coffee store'
        });
    });
